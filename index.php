				...
				<div class="col-md-4 login-sec">
					...
					<form class="login-form" method="post" action="carousel.php">
						...
						<div class="form-group">
							<input type="text" class="form-control" name="tischNummer"
								placeholder="Tischnummer" maxlength="50">
						</div>

						<div class="form-check" align="right">
							<INPUT TYPE="submit" value="Starten" onClick="tischnrAbsenden()"
								name="loginTischNr">
				...
				<div id="carouselExampleIndicators" class="carousel slide"
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
							<img class="d-block" src="Bilder/gedecktertischzwei.jpg"
								alt="First slide" width="780">
							<div class="carousel-caption d-none d-md-block"></div>
						</div>

						<div class="carousel-item">
							<img class="d-block" src="Bilder/wochenkartezwei.jpg"
								alt="First slide" width="780">
							<div class="carousel-caption d-none d-md-block"></div>
						</div>
					</div>
